      ...
      <Card className="border-know/25">
        <div className="flex items-center gap-2.5 px-5 py-3">
          ...
          <p className="text-caption text-ink-2">
            Пока синхронизация не настроена, дневник никуда не отправляется.
            После настройки синхронизируется как и всё остальное — отдельного
            исключения для личных записей больше нет. Метка «личное» ниже —
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <Field
                ...
                подсказка="Пустое не станет нулём"
              >
                <Input
                  type="number"
                  min={1}
              ...
              <Field подпись="Сон, часов" подсказка="Пустое не станет нулём">
                <Input
                  type="number"
                  min={0}
                  max={24}
            ...
            <Switch
              ...
              описание="Пометка для себя — на синхронизацию не влияет"
            />
          </div>
        ) : null}
      </Dialog>
