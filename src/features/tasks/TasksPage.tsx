...
export function TasksPage() {
  ...
  async function сохранить() {
    ...
    if (
      черновик.длительностьМинут !== null &&
      черновик.длительностьМинут !== undefined &&
      (!Number.isInteger(черновик.длительностьМинут) ||
        черновик.длительностьМинут < 5 ||
        черновик.длительностьМинут > 480)
    ) {
                ...
                <div key={задача.id} className="flex items-center gap-3 px-5 py-3">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-0.5 flex flex-wrap items-center gap-1.5 text-caption text-ink-3">
                      ...
                      {задача.длительностьМинут !== null ? (
                        <Badge>{задача.длительностьМинут} мин</Badge>
                      ) : (
                        <Badge тон="внимание">время неизвестно</Badge>
                      )}
        ...
        {черновик ? (
          <div className="space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              ...
              <Field
                подпись="Минут"
                подсказка="Нужно для вместимости дня; пусто — неизвестно"
              >
                <Input
                  type="number"
                  min={5}
