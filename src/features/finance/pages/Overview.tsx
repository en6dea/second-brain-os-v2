...
export function FinanceOverview() {
  ...
  const посчитано = useMemo(() => {
    ...
    return { итог, долги, период, свободно, категории, помесячно }
  }, [данные, месяц])
      ...
      <Card>
        <div className="grid grid-cols-2 gap-5 p-5 lg:grid-cols-4">
          <Metric
            ...
            значение={деньги(посчитано.итог.собственные)}
            источник={
          ...
          <Metric
            ...
            значение={деньги(посчитано.свободно)}
          ...
          <Metric
            единица="₽ · долг"
            подпись="Я должен"
            значение={деньги(посчитано.долги.яДолжен)}
